...
Config = {
	Framework = "esx",											-- set this to either "qb" or "esx"
	...
	Phone = "OldQsPhone",										-- set this to the name of the method, pass as string. options are "NPWD","lbphone", "RenewedPhone","OldQsPhone","NewQsPhone","QbPhone","yflip", "RoadPhone", "gks","okok", "jpPhone"
